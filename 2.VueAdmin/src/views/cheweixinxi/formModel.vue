		...
		<el-dialog v-model="formVisible" :title="formTitle" width="50%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="收费规则" prop="shoufeiguize">
							<el-input class="list_inp" v-model="form.shoufeiguize" placeholder="收费规则"
								 type="text" 								:readonly="!isAdd||disabledForm.shoufeiguize?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shoufeiguize'){
					form.value.shoufeiguize = row[x];
					disabledForm.value.shoufeiguize = true;
					continue;
				}
